  ...
  return (
    <section className={styles.section}>
      ...
      <p>
        ...
        you, whether personally or on behalf of an entity (“you”) and Kay Moz
        Ceramics (“Company“, “we”, “us”, or “our”), concerning your access to
        and use of the https://www.kaymozceramics.com website as well as any
      ...
      <p>
        ...
        https://www.kaymozceramics.com/privacy-policy/. By using the Site, you
      ...
      <p>
        ...
        the arbitration will take place in Nassau County, New York. Except as
      ...
      <p>
        ...
        courts located in Nassau County, New York, and the Parties hereby
      ...
      <p>
        ...
        CAUSE OF ACTION ARISING OR $500.00 USD. CERTAIN STATE LAWS DO NOT ALLOW
